...
> ⚙️ **Загрузи:**
> 1. `view(/mnt/skills/user/goap-research/SKILL.md)` — адаптивный поиск отзывов
...
|-------|-------|-----------------|
| `goap-research` | DEEP | Адаптивный поиск отзывов: A* по платформам + OODA при пустых results |
