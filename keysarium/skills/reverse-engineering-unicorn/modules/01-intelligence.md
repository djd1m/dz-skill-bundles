...
> ⚙️ **Перед началом:** `view(/mnt/skills/user/goap-research/SKILL.md)`
...
|-------|-------|-----------------|
| `goap-research` | DEEP | GOAP-методология: State → Actions → A* → OODA |
...
| External skills | Нет | goap-research, goap-research-ed25519 | Reuse проверенных методологий |
